...
from pysuez import PySuezConnexionError, PySuezError, SuezClient
...
class SuezWaterCoordinator(DataUpdateCoordinator[SuezWaterData]):
    ...
    async def _async_update_data(self) -> SuezWaterData:
        ...
        except PySuezConnexionError as ex:
            raise ConfigEntryAuthFailed("Invalid credentials for suez water") from ex
